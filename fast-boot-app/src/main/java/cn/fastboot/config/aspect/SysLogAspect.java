package cn.fastboot.config.aspect;

import cn.fastboot.config.aspect.log.annotations.SystemLog;
import cn.fastboot.config.aspect.log.model.SysLog;
import cn.fastboot.config.aspect.log.utils.IpInfoUtil;
import cn.fastboot.config.aspect.log.utils.SysLogUtils;
...
public class SysLogAspect {
    ...
    @Pointcut("@annotation(cn.fastboot.config.aspect.log.annotations.SystemLog)")
