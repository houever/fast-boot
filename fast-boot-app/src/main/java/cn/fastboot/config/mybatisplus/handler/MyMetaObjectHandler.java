package cn.fastboot.config.mybatisplus.handler;

import cn.fastboot.base.exception.BusinessExcpetion;
import cn.fastboot.config.mybatisplus.tenant.TenantContextHolder;
