package cn.fastboot.config;

import cn.fastboot.config.inteceptors.ReqInterceptor;
import cn.fastboot.config.advice.CustomRequestBodyAdvice;
import cn.fastboot.config.advice.ExceptionHandlerAdvice;
import cn.fastboot.config.advice.callable.CustomDeferredResultProcessingInterceptor;
